...
const sys = require(_path2.default.resolve(__dirname, '../package.json'));
...
function createFile(filename, callback) {
  ...
  return _fs2.default.writeFile(_path2.default.join(cwd, filename), (0, _render2.default)(filename.indexOf('.') === 0 ? filename.substr(1) : filename)(locals), callback);
}
